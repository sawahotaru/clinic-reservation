...
<?php page_head('使い方ガイド | ' . ($s['shop_name'] ?: 'サンプル整体院'), '../'); ?>
    ...
    <nav class="guide-toc" aria-label="目次">
      ...
      <ol>
        ...
        <li><a href="#stats">お店の傾向を数字で見る</a></li>
    ...
    <p class="guide-warn">
      ⚠️ <strong>設定をやり直すときの注意</strong><br>
      いったん「無効にする」を押してから設定し直すと、<strong>鍵はまったく新しいものが作られます</strong>。
      このとき<strong>スマホのアプリに残っている古い登録を消してください</strong>。
      消さないと同じ名前が2つ並び、<strong>古いほうの数字を入れてしまって
      「認証コードが違います」と出ます</strong>。うまく入れないときは、たいていこれが原因です。<br>
      リカバリコードも作り直しになるので、<strong>古い控えは破棄して新しいものを保管</strong>してください。
    </p>

    <!-- ============================================================ -->
    <h2 id="stats">8. お店の傾向を数字で見る</h2>

    <p>
      上のメニューの <a href="stats.php">統計</a> に、これまでのご予約をまとめた数字が出ます。
      入力や設定は要りません。<strong>見るだけのページ</strong>です。
    </p>

    <ul class="guide-steps">
      <li><strong>いまの状況</strong> — 今月の件数と先月との差、これから先に入っているご予約の数。</li>
      <li><strong>月ごとの件数</strong> — 直近12ヶ月の推移。忙しい時期と落ちる時期が一目で分かります。</li>
      <li><strong>曜日ごと・時間帯ごと</strong> — どの曜日・どの時間に集まっているか。
          <strong>ここがいちばん使えます</strong>: 夕方ばかり埋まるなら、
          <a href="slots.php">予約枠設定</a>で営業時間を後ろにずらす、といった判断ができます。</li>
      <li><strong>リピートの状況</strong> — 2回以上お越しの方の割合と、ご来院の多い方。</li>
    </ul>

    <p class="guide-note">
      ⚠️ 数字に入るのは<strong>いま予約として残っているぶん</strong>だけです。
      取り消したご予約は記録ごと消える仕組みなので、「何件キャンセルされたか」は分かりません。
    </p>

    <!-- ============================================================ -->
    <h2 id="faq">9. 困ったとき（よくある質問）</h2>
